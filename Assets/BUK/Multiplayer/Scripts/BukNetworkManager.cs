...
namespace Buk.Multiplayer
{
    ...
    public class BukNetworkManager : NetworkManager
    {
        ...
        /// </summary>
        /// <param name="conn">The NetworkConnectionToClient to replace the player for</param>
        ...
        public GameObject ReplacePlayer(NetworkConnectionToClient conn, GameObject newPlayer, bool destroyOld, bool instantiateNew)
        {
